...
function content_636b59e033b374_05467101 (Smarty_Internal_Template $_smarty_tpl) {
...
<i class="fas fa-arrow-circle-right ml5"></i></button>
          ...
          <div class="js_wizard-content x-hidden" id="step-3">
            <div class="text-center">
              <h3 class="mb5"><?php echo __("Add Interests");?>
</h3>
