<?php
/* Smarty version 4.2.0, created on 2022-11-02 06:38:44
  from '/home/u246756914/domains/waybillion.link/public_html/content/themes/default/templates/__feeds_post.comments.category.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_63621074a0eef0_02348420',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b43aae8167d5111e8fc643c21430758b0835a584' => 
    array (
      0 => '/home/u246756914/domains/waybillion.link/public_html/content/themes/default/templates/__feeds_post.comments.category.tpl',
      1 => 1667371121,
      2 => 'file',
    ),
  ),
...
function content_63621074a0eef0_02348420 (Smarty_Internal_Template $_smarty_tpl) {
...
" data-remove="true" data-target-stream=".js_comments">
  ...
  <?php } else { ?>
    ...
    <!-- sort comments -->
    <?php if ($_smarty_tpl->tpl_vars['article']->value['comments'] > 0) {?>
      <div class="comments-filter">
        <div class="btn-group btn-group-sm js_comments-filter" data-value="post_comments">
          ...
          <div class="dropdown-menu dropdown-menu-left">
            <div class="dropdown-item pointer" data-value="post_comments" data-id="<?php echo $_smarty_tpl->tpl_vars['article']->value['post_id'];?>
"><?php echo __("Most Recent");?>
</div>
            <div class="dropdown-item pointer" data-value="post_comments_top" data-id="<?php echo $_smarty_tpl->tpl_vars['article']->value['post_id'];?>
"><?php echo __("Top Comments");?>
</div>
            <div class="dropdown-item pointer" data-value="post_comments_all" data-id="<?php echo $_smarty_tpl->tpl_vars['article']->value['post_id'];?>
"><?php echo __("All Comments");?>
</div>
          </div>
        </div>
    ...
    <!-- post comment -->
    <?php $_smarty_tpl->_subTemplateRender('file:__feeds_comment.form.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('_handle'=>'post','_id'=>$_smarty_tpl->tpl_vars['article']->value['post_id']), 0, true);
?>
    <!-- post comment -->
    ...
    <!-- comments -->
    <ul class="js_comments <?php if ($_smarty_tpl->tpl_vars['article']->value['comments'] > 0) {?>pt10<?php }?> <?php if ($_smarty_tpl->tpl_vars['_live_comments']->value) {?>js_live-comments<?php }?>">
      <?php if ($_smarty_tpl->tpl_vars['article']->value['comments'] > 0) {?>
        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['article']->value['post_comments'], 'comment');
$_smarty_tpl->tpl_vars['comment']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['comment']->value) {
$_smarty_tpl->tpl_vars['comment']->do_else = false;
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <!-- previous comments -->
    <?php if ($_smarty_tpl->tpl_vars['article']->value['comments'] >= $_smarty_tpl->tpl_vars['system']->value['min_results']) {?>
      <div class="ptb10 text-center js_see-more" data-get="post_comments" data-id="<?php echo $_smarty_tpl->tpl_vars['article']->value['post_id'];?>
" data-remove="true" data-target-stream=".js_comments">
        <span class="text-link">
          <i class="fa fa-comment"></i>
          <?php echo __("View previous comments");?>
