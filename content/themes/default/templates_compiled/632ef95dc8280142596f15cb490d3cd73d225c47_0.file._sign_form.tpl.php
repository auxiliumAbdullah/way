<?php
/* Smarty version 4.2.0, created on 2022-11-09 19:20:37
...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_636b8d054bdda7_70959815',
...
function content_636b8d054bdda7_70959815 (Smarty_Internal_Template $_smarty_tpl) {
         ...
         <div class="form-group"  id="Phone">
          <div class="input-group">
            <div class="input-group-prepend">
              ...
              <select name="user_ph" id="phone_code" class="form-control" required>
                <?php
         ...
         <div class="form-group">
            <div class="input-group">
              ...
              <select name="registration_method" id="regmethod" class="form-control" required>
                      ...
                      <option value="" disabled selected>Register via</option>
                    <option value="ByPhone">Phone number</option>
                    <option value="ByEmail">Email</option>
              </select>
            </div>
