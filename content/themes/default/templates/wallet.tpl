        ...
        <div class="card mt20">
          ...
          <div class="card-body">
			...
			{if $offer_pay}
              <div class="alert alert-success mb20">
                <i class="fas fa-check-circle mr5"></i>
                {__("Congratulation! You have purchased new offer")} <span class="badge badge-pill badge-lg badge-light">{print_money($wallet_package_payment_amount|number_format:2)}</span> {__("payment transaction successfuly done")}
              </div>
            {/if}
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              {elseif $transaction['node_type'] == "package_payment"}
                                {__("Buy Pro Package")}
							  {elseif $transaction['node_type'] == "offer_pay"}
                                {__("Buy Offer")}
							  {elseif $transaction['node_type'] == "product"}
                                {__("Buy Product")}
                              {/if}
                            </td>
