    ...
    <div class="col-md-8 col-lg-9 offcanvas-mainbar">
      ...
      <div class="content-tabs rounded-sm shadow-sm clearfix">
        <ul>
          ...
          <li {if  $view == "friends"}class="active" {/if}>
            <a href="{$system['system_url']}/people/friends">{__("Friends")}</a>
          </li>
        </ul>
      </div>
      <!-- tabs -->
          ...
          <div class="card">
            ...
            {elseif $view == "sent_requests"}
              ...
              <div class="card-body">
                ...
                <!-- see-more -->
                {if count($user->_data['friends']) >= $system['max_results']}
