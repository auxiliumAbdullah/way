    ...
    <div class="col-12 col-md-10 mx-md-auto">
      <div class="card shadow">
        <div class="card-body text-center">
          ...
          <h2>{__("Hey")} 👋 {__("Let's verify your")} {if $user->_data['registration_method'] == "ByEmail"}{__("Email")}{else}{__("Phone Number")}{/if}</h2>
          <p class="text-xlg mt10 mb30">
            ...
            {else}
              {__("Please check the SMS on your oooo phone")} <strong>{$user->_data['user_phone']}</strong> {__("to complete the activation process")}
            {/if}
          </p>
