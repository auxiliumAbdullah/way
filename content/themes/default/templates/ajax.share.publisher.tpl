    ...
    {if $system['social_share_enabled']}
      <div class="post-social-share">
        ...
        <a href="https://twitter.com/intent/tweet?url={$system['system_url']}/posts/{$post['post_id']}" class="btn btn-sm btn-rounded btn-social-icon btn-rounded btn-twitter" target="_blank">
		 ...
		 <a href="https://www.wechat.com/share.php?url={$system['system_url']}/posts/{$post['post_id']}" class="btn btn-sm btn-rounded btn-social-icon btn-vk we-chat" target="_blank">
          <i class="fa fa-wechat"></i>
        </a>
        <a href="https://vk.com/share.php?url={$system['system_url']}/posts/{$post['post_id']}" class="btn btn-sm btn-rounded btn-social-icon btn-vk btnwexin" target="_blank">
          <i class="fa-weixin"></i>
        </a>
