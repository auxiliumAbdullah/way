...
{else}
  <div class="post-media list">
    	<div class="post-media-meta">
          <h5><a href="{$system['system_url']}/blogs/{$article['post_id']}/{$article['article']['title_url']}">{$article['article']['title']}</a></h5>
          <div class="info">
            {__("By")}
	...
	<h2><a href="{$system['system_url']}/blogs/{$article['post_id']}/{$article['article']['title_url']}" class="btn btn-sm btn-success btn-block">Read More</a></h2>
