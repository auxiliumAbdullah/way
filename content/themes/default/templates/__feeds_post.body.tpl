...
<div class="post-header" data-aos="fade-up"
  ...
  <div class="post-meta">
    ...
    {elseif $_post['post_type'] == "link" && $_post['link']}
     ...
     data-aos-duration="1000">
          {if $_post['link']['source_thumbnail']}
            <a class="post-media-image" href="{$_post['link']['source_url']}" target="_blank" rel="nofollow" data-aos="fade-up"
     data-aos-duration="1000">
    ...
    {elseif $_post['post_type'] == "media" && $_post['media']}
     ...
     data-aos-duration="1000">
              <div class="image" style="background-image:url('{$_post['media']['source_url']}');" data-aos="fade-up"
     data-aos-duration="1000"></div>
            </div>
            <div class="post-media-meta" data-aos="fade-up" data-aos-duration="1000">
              <div class="source" data-aos="fade-up"
     data-aos-duration="1000"><a target="_blank" href="{$_post['media']['source_url']}">{$_post['media']['source_provider']}</a></div>
            </div>
          </div>
        {else}
      ...
      <div class="mt10">
        <div class="post-media">
          ...
          <div class="post-media-meta" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="text mb5"><a class="post_text_custom" href="{$system['system_url']}/blogs/{$_post['post_id']}/{$_post['article']['title_url']}">{$_post['article']['parsed_text']}</a></div>
          </div>
        </div>
      </div>
    ...
    {elseif $_post['post_type'] == "funding" && $_post['funding']}
      <div class="mt10">
        <div class="post-media" data-aos="fade-up"
     data-aos-duration="1000">
          <a class="post-media-image" href="{$system['system_url']}/posts/{$_post['post_id']}" target="_blank" data-aos="fade-up"
     data-aos-duration="1000">
    ...
    {elseif $_post['post_type'] == "offer" && $_post['offer']}
     ...
     data-aos-duration="1000">
          <a class="post-media-image" href="{$system['system_url']}/posts/{$_post['post_id']}" target="_blank">
            <div class="image" style="background-image:url('{$system['system_uploads']}/{$_post['offer']['thumbnail']}');" data-aos="fade-up"
     data-aos-duration="1000"></div>
            <div class="source">
